...
RSpec.describe RuboCop::Cop::Angellist::GraphqlFieldNameCamelized, :config do
  ...
  it 'registers an offense for snake_case field name' do
    expect_offense(<<~RUBY)
  ...
  it 'registers an offense even when method: is present but name is snake_case' do
    expect_offense(<<~RUBY)
      class Types::MyType < Types::BaseObject
  ...
  it 'correctly camelizes multi-word field names' do
    expect_offense(<<~RUBY)
      class Types::MyType < Types::BaseObject
